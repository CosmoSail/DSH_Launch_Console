...
if "%INSTDIR%"=="" (
  if "%~2"=="" (
    ...
    powershell -NoProfile -STA -ExecutionPolicy Bypass -EncodedCommand 
...
>> "!INSTDIR!\uninstall.bat" echo del /F /Q "%%APPDATA%%\Microsoft\Windows\Start Menu\Programs\DeepSeek Harness browser.lnk" ^>nul 2^>^&1
>> "!INSTDIR!\uninstall.bat" echo del /F /Q "%%USERPROFILE%%\Desktop\DeepSeek Harness browser.lnk" ^>nul 2^>^&1
>> "!INSTDIR!\uninstall.bat" echo del /F /Q "%%PUBLIC%%\Desktop\DeepSeek Harness browser.lnk" ^>nul 2^>^&1
>> "!INSTDIR!\uninstall.bat" echo reg delete "HKCU\Software\Microsoft\Windows\CurrentVersion\Uninstall\DeepSeek Harness browser" /f ^>nul 2^>^&1
...
reg add "HKCU\Software\Microsoft\Windows\CurrentVersion\Uninstall\DSH_Launch_Console" /v DisplayVersion /d "0.1.0" /f >nul
